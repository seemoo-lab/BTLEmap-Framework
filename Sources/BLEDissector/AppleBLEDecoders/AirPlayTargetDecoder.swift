...
public extension AppleBLEDecoding {
    struct AirPlayTargetDecoder: AppleBLEDecoder {
        ...
        public func decode(_ data: Data) throws -> [String : DecodedEntry] {
            ...
            let flags = data[i]
            describingDict["flags"] = DecodedEntry(value: flags, byteRange: i...i)
            i+=1
            
            let configSeed = data[i]
            describingDict["configSeed"] = DecodedEntry(value: configSeed, byteRange: i...i)
            i+=1
            ...
            if  inet_ntop(AF_INET, &ipArray, &ipString, 32) != nil {
                ...
                describingDict["ipv4Address"] = DecodedEntry(value: ipv4AddressStirng, byteRange: i...i+3)
            }else {
                describingDict["ipv4AddressHex"] = DecodedEntry(value: ipv4Address.hexadecimal, byteRange: i...i+3)
            }
